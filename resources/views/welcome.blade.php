...
@section('content')
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"><img class="d-inline-block me-3" src="{{asset('asset/img/icons/logo.png')}}" alt="" />Posyandu</a>
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#">Home</a></li>
              <li class="nav-item"><a class="nav-link" href="#tentang">Tentang Desa</a></li>
        ...
        <div class="container-lg">
          <div class="row justify-content-center">
            <div class="col-auto text-center">
              <h2 class="fw-bold">Tentang Desa</h2>
      ...
      <section class="py-8" id="visimisi">
        <div class="bg-holder" style="background-image:url({{asset('asset/img/illustrations/dot-2.png')}});background-position:center right;background-size:auto;margin-left:-180px;margin-top:20px;">
        </div>
        <!--/.bg-holder-->
        <div class="bg-holder" style="background-image:url({{asset('asset/img/illustrations/dot.png')}});background-position:right bottom;background-size:auto;margin-top:50px;"></div>
        ...
        <div class="container-lg">
          ...
          <div class="row h-100 justify-content-center pt-6">
            <div class="col-12 col-sm-9 col-md-4 mt-4">
              <div class="card h-100 rounded-3 shadow"><img src="{{asset('asset/img/gallery/article-1.png')}}" alt="" />
            ...
            <div class="col-12 col-sm-9 col-md-4 mt-4">
              <div class="card h-100 rounded-3 shadow"><img src="{{asset('asset/img/gallery/article-2.png')}}" alt="" />
                <div class="card-body p-4 text-center text-md-start">
            ...
            <div class="col-12 col-sm-9 col-md-4 mt-4">
              <div class="card h-100 rounded-3 shadow"><img src="{{asset('asset/img/gallery/article-3.png')}}" alt="" />
                <div class="card-body p-4 text-center text-md-start">
            ...
            <div class="text-center pt-4 z-index-2">
              <a href="{{ route('article') }}" class="btn btn-lg btn-outline-primary rounded-pill z-index-2 hover-top" type="submit">Lihat Semua Artikel</a>
            </div>
          </div>
        </div>
      </section>
    
      <section id="galeri" class="py-8">
        <div class="bg-holder" style="background-image:url({{asset('asset/img/illustrations/article-bg.png')}});background-position:right center;background-size:auto;">
        </div>
        <!--/.bg-holder-->
